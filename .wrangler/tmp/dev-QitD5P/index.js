...
// .wrangler/tmp/bundle-v1LQNk/strip-cf-connecting-ip-header.js
...
function getLocationSuggestions(query) {
  ...
  return locations.filter(
    (loc) => loc.canonical_name.toLowerCase().includes(query.toLowerCase())
  ).slice(0, 5);
}
__name(getLocationSuggestions, "getLocationSuggestions");
...
// .wrangler/tmp/bundle-v1LQNk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-v1LQNk/middleware-loader.entry.ts
